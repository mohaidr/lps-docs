...
Each point on the chart represents one window. If a window captured 200 requests, the P95 shown is the 95th percentile of those 200 requests alone.
...
Windowed metrics are sensitive by design. They sacrifice stability for responsiveness, making them ideal for catching issues as they happen.
...
**Includes:**  
TCP + TLS + Sending + Waiting (upload + server + network) + Receiving
...
### WaitingTime
> Defined as: `TTFB – TCP – TLS`

**What It Actually Includes:**
- Upload time (request travelling to the server)
