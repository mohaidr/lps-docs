...
- `-cdcp`, `--cooldowncpupercentage <cooldowncpupercentage>`:  
...
- `-cdrtims`, `--cooldownretrytimeinms <cooldownretrytimeinms>`:  
  Interval (in milliseconds) for checking if the test can be resumed.
