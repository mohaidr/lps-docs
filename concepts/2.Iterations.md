...
See the [Before Expressions article](https://github.com/mohaidr/lps-docs/blob/main/articles/17.Before.md) and the [`find` method](https://github.com/mohaidr/lps-docs/blob/main/articles/4.Declerative%20Methods.md#find).
...
See the [before & after Expressions article](https://github.com/mohaidr/lps-docs/blob/main/articles/17.Before.md).
...
| `SkipRatio` | `SkippedRatio`, `SkippedRequestsRatio` | (none) | Percentage of skipped requests out of total attempted requests | `"SkipRatio > 0.10"` |
| `Throughput` | `RPS`, `RequestsPerSecond` | (none) | Requests per second | `"Throughput < 100"` |
| `RequestsRatePerCoolDownPeriod` | `RPSCD` | (none) | Requests per cooldown interval for cooldown-based modes | `"RPSCD < 20"` |
